...
def main(argv, inputfile='C:/Users/hfergus2/Desktop/MyPythonExport/L_2Floor_2016.xml', outputpath='Output/', modelflag='3', devflag="1", shadowflag="0", locationfile = 'C:/Users/hfergus2/Desktop/GSBranch/Locations/USA_VA_Sterling-Washington.Dulles.Intl.AP.724030_TMY3.epw'):
    if len(sys.argv) == 8:
